...
public class ApartmentsApiController implements ApartmentsApi {
    ...
    @Autowired
    public ApartmentsApiController(NativeWebRequest request, ApartmentService apartmentService) {
