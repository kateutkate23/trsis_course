...
public interface DeleteApi {
    ...
    /**
     * DELETE /delete : delete an apartment
     * delete apartment by id
     *
     * @param id id (required)
     * @return info about deleted apartment (status code 200)
    ...
    @Operation(
        ...
        tags = { "Apartment" },
        responses = {
            @ApiResponse(responseCode = "200", description = "info about deleted apartment", content = {
    ...
    default ResponseEntity<Apartment> deleteApartment(
        @NotNull @Parameter(name = "id", description = "id", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "id", required = true) Integer id
    ) {
